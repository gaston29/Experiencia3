...
// Fade (o fading) Led
 // Si la distancia es menor a 336 cm. Dato que se modificó
  if (cm<336)  

 {    
  // Brillo de led aumnta en la medida que se aleja hasta 336 cm. Se invirtió al código original
  cm2 = cm - 336;  
  //  valor entregado = map(valor que recibo, de Mínimo, de Máximo, a Mínimo, a Máximo). Se
  // modifico el rango operacional
...
// Delay hace gradual el fade (desvanecimiento del led). Se modificó el delay a uno menor
  delay(50);
 }
//Fin de loop
